...
class TestParseReq(unittest.TestCase):
    ...
    def test_basic_and(self):
        ...
        expected = ReqList.flatten(expected)

        result = ReqList.flatten(parse_req_string(in_str))
    ...
    def test_one_multi_or_one_singular_and(self):
        ...
        self.assertEqual(expected, ReqList.flatten(parse_req_string(in_str)))
